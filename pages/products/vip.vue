...
export default {
  ...
  computed: {
    ...mapState({
      ...
      pagination: ({ home }) => home.vipProducts.meta || {}
    }),
    ...mapGetters({
      products: "home/getVipProducts"
    })
  },
  watch: {
    "$route.query"(query) {
      this.$store.dispatch("home/fetchVipProducts", query)
        .then(() => {
          this.$scrollTo("#root");
        })
    }
  ...
  async asyncData({ store, query }) {
    await store.dispatch("home/fetchVipProducts", query)
  }
}
</script>
