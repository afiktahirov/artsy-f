...
export default {
  ...
  computed: {
    ...mapState({
      data: ({ pages }) => pages.privacyPolicy.data
    })
  },
  async asyncData({ store }) {
    await store.dispatch("pages/fetchPrivacyPolicy")
  }
}
</script>
